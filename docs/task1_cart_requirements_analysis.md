...
- В исходном фрагменте отсутствует пункт 12 (нарушена нумерация), из-за этого сложнее ссылаться на требования при обсуждении.
...
4.1. Нужно ли логировать попытки превышения лимитов (для аналитики и работы поддержки)?
